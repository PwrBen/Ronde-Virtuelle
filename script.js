// Base de données des anomalies affectées aux bons blocs
const qcmData = {
    "bloc1": { // Issue de secours mal verrouillée
        question: "L'issue de secours du bâtiment (BLOC 1) est entrouverte. Quelle est la bonne procédure ?",
        options: [
    ...
    "bloc2": { // Grillage découpé
        question: "Vous constatez un trou découpé dans le grillage d'enceinte (BLOC 2). Que devez-vous faire ?",
        options: [
    ...
    "bloc3": { // Poubelle placée sous la fenêtre
        question: "Vous remarquez une poubelle positionnée sous une fenêtre du rez-de-chaussée (BLOC 3). Que faites-vous ?",
        options: [
...
function verifierReponse(bouton, estCorrect, explication) {
    ...
    if (estCorrect) {
        ...
        // Valider l'anomalie si elle n'a pas déjà été trouvée
